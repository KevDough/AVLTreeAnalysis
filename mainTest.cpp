...
int main(int argc, char** argv) {
    ...
    string launchfile(argv[1]);
    ifstream launchIn(launchfile.c_str());
    string launchLine;
    int flightCost;
    getline(launchIn, launchLine);
    sscanf(launchLine.c_str(), "%d", &flightCost);
